...
public class PetDetailTest extends Common {
	...
	@Test(enabled = true, groups = { SMOKE }, description = "get pet by id returns HTTP OK")
	...
	@Test(enabled = true, groups = { SMOKE, REGRESSION }, description = "get pet by id returns a pet")
	...
	@Test(
			enabled = true, 
			groups = { REGRESSION }, 
			description = "non existing pet id returns HTTP not found and correct error message",
			dataProvider = "Unsuccessful getPetById")
	public void GetPetUnsuccessfullyTest(
